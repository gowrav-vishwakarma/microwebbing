...
if (!defined('MW_SYSTEMFILES_FOLDER_NAME')) {
    define('MW_SYSTEMFILES_FOLDER_NAME', 'system');
}
...
if (!defined('MW_SYSTEMFILES')) {
    define('MW_SYSTEMFILES', MW_ROOTPATH . MW_SYSTEMFILES_FOLDER_NAME . DS);
}
if (!defined('MW_USERFILES')) {
    define('MW_USERFILES', MW_ROOTPATH . MW_USERFILES_FOLDER_NAME . DS);
}

if (!defined('MW_SYSTEMFILES_URL')) {
    define("MW_SYSTEMFILES_URL", MW_SITE_URL . MW_SYSTEMFILES_FOLDER_NAME);
}
...
if (!defined('MW_MODULES_DIR')) {
    define("MW_MODULES_DIR", MW_SYSTEMFILES . 'modules' . DS);
}

if (!defined('MW_TEMPLATES_DIR')) {
    define('MW_TEMPLATES_DIR', MW_SYSTEMFILES . MW_TEMPLATES_FOLDER_NAME . DS);
}
if (!defined('MW_TEMPLATES_URL')) {
    define('MW_TEMPLATES_URL', MW_SYSTEMFILES_URL .'/'. MW_TEMPLATES_FOLDER_NAME.'/');
}
...
if (!defined('MW_ELEMENTS_DIR')) {
    define('MW_ELEMENTS_DIR', MW_SYSTEMFILES . 'elements' . DS);
}
if (!defined('MW_ELEMENTS_DIR')) {
    define('MW_ELEMENTS_DIR', MW_SYSTEMFILES . 'elements' . DS);
}
if (!defined('MW_ELEMENTS_URL')) {
    define('MW_ELEMENTS_URL', MW_SYSTEMFILES_URL . 'elements/');
}
if (!defined('MW_MODULES_URL')) {
    define('MW_MODULES_URL', MW_SYSTEMFILES_URL . 'modules/');
}
